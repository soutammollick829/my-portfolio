...
import projectImage5 from "../../../assets/my project/boss.jpg";
          ...
          <Tilt>
            <div className="card card-compact lg:w-96 h-96 bg-base-100 shadow-xl mt-10">
              ...
              <div className="card-body">
                ...
                <div className="card-actions justify-end">
                <a href="https://64a2e315ac33f71f0ffd4cb6--superb-banoffee-96b16b.netlify.app/" target="blank" className="btn btn-sm bg-gradient-to-r from-[#1c7ed6] to-[#22b8cf] text-white"><FaGlobe/> demo</a>
                  <a href="https://github.com/soutammollick829/bistro-boss-restarurent-client" target="blank" className="btn btn-sm bg-gradient-to-r from-[#1c7ed6] to-[#22b8cf] text-white"><FaCode/>Client</a>
                  <a href="https://github.com/soutammollick829/bistro-boss-server" target="blank" className="btn btn-sm bg-gradient-to-r from-[#1c7ed6] to-[#22b8cf] text-white"><FaDatabase/> server</a>
                </div>
              </div>
            </div>
          </Tilt>
